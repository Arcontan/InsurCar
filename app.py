...
<style>
    ...
    /* Fix ALL input fields with correct Streamlit selectors */
    .stNumberInput input,
    .stTextInput input,
    .stSelectbox select,
    .stSlider .stSlider,
    ...
    /* Fix metric value numbers specifically */
    ...
    /* Fix success/info/error message text */
    .stSuccess,
    .stInfo,
    .stError,
    .stWarning,
    ...
    /* Fix success message text specifically */
    .stSuccess > div,
...
if st.session_state.step == 1:
    ...
    try:
        ...
        numerical_features = [
            all_data['age_of_car'], all_data['age_of_policyholder'], all_data['airbags'], 
            all_data['cylinder'], all_data['displacement'], all_data['gear_box'], 
            all_data['gross_weight'], all_data['height'], all_data['length'], 
            all_data['max_power_numeric'], all_data['max_torque_numeric'], 
            all_data['ncap_rating'], all_data['policy_tenure'], all_data['population_density'], 
            all_data['turning_radius'], all_data['width']
        ]
        ...
        features = np.array([[
            ...
            scaled_numerical[3],
            scaled_numerical[4],
            all_data['fuel_type_Diesel'],
            all_data['fuel_type_Petrol'],
            scaled_numerical[5],
            scaled_numerical[6],
            scaled_numerical[7],
            all_data['is_adjustable_steering'],
            all_data['is_brake_assist'],
            all_data['is_central_locking'],
            all_data['is_day_night_rear_view_mirror'],
            all_data['is_driver_seat_height_adjustable'],
            all_data['is_ecw'],
            all_data['is_esc'],
            all_data['is_front_fog_lights'],
            all_data['is_parking_camera'],
            all_data['is_parking_sensors'],
            all_data['is_power_door_locks'],
            all_data['is_power_steering'],
            all_data['is_rear_window_defogger'],
            all_data['is_rear_window_washer'],
            all_data['is_rear_window_wiper'],
            all_data['is_speed_alert'],
            all_data['is_tpms'],
            scaled_numerical[8],
            scaled_numerical[9],
            scaled_numerical[10],
            ...
            scaled_numerical[12],
            scaled_numerical[13],
            all_data['rear_brakes_type_Drum'],
            all_data['steering_type_Manual'],
            all_data['steering_type_Power'],
            all_data['transmission_type_Manual'],
            scaled_numerical[14],
            scaled_numerical[15]
        ]])
